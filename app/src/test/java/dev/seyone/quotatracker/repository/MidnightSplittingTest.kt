...
class MidnightSplittingTest {
    ...
    class FakeQuotaDao : QuotaDao {
        ...
        ) = flowOf(emptyList<dev.seyone.quotatracker.data.local.model.QuotaWithProgress>())
    ...
    class FakeLogEntryDao : LogEntryDao {
        ...
        override fun getAllLogsWithQuotas() = flowOf(emptyList<dev.seyone.quotatracker.data.local.model.LogEntryWithQuota>())
